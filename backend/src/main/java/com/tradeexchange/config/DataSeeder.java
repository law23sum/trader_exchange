...
public class DataSeeder {
  ...
  private void insertUsers(){
    ...
    jdbc.update("INSERT OR IGNORE INTO users (id,name,email,password,role,createdAt,providerPlayerId) VALUES (?,?,?,?,?,?,?)",
      "u_demo","Demo User","user@example.com","password","USER",now,null
    );
    jdbc.update("INSERT OR IGNORE INTO users (id,name,email,password,role,createdAt,providerPlayerId) VALUES (?,?,?,?,?,?,?)",
      "u_morgan","Morgan Harper","trader@example.com","password","TRADER",now,"p_morgan"
    );
    jdbc.update("INSERT OR IGNORE INTO users (id,name,email,password,role,createdAt,providerPlayerId) VALUES (?,?,?,?,?,?,?)",
      "u_admin","Admin","admin@example.com","password","ADMIN",now,null
    );
  }
}
